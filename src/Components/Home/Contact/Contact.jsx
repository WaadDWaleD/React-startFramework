      ...
      <div className="container">
        ...
        <div className="w-50 mx-auto">
          <div class="input-container">
            ...
            />
            <label for="uName" class="input-label text-uppercase ">
              User Name
            </label>
          </div>
          ...
          <div class="input-container">
            ...
            />
            <label for="uAge" class="input-label text-uppercase">
              User Age
            </label>
          </div>
          ...
          <div class="input-container">
            ...
            />
            <label for="uEmail" class="input-label text-uppercase ">
              User Email
            </label>
          </div>
          ...
          <div class="input-container">
            ...
            />
            <label for="uPass" class="input-label text-uppercase">
              User Password
            </label>
          </div>

          <button className="btn btn-custom px-5">Submit</button>
        </div>
      </div>
    </section>
  );
