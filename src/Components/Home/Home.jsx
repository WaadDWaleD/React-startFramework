...
export default function Home() {
  return (
    <section
      id="home"
      className="min-vh-100 style d-flex justify-content-center align-items-center"
    >
      <div className="container text-center p-3 mt-5">
        <img src={avatar} alt="avatar" />
        <h1 className="text-white display-6 fw-bold mt-4 text-uppercase">start framework</h1>
